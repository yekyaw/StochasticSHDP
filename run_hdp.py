...
def parse_args():
  parser = OptionParser()
  parser.set_defaults(C=2, T=300, K=20, D=-1, W=-1, eta=0.01, alpha=1.0, gamma=1.0,
  ...
  parser.add_option("--C", type="int", dest="C",
...
def run_hdp():
  ...
  bhdp = hdp.hdp(options.C, options.T, options.K, options.D, options.W, options.eta, bhdp_hp)
